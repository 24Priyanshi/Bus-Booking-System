...
def add_op():
    ...
    if not (op_address and op_id and op_email and op_phone and op_name):
        ...
        return
    if len(op_phone) != 10:
        messagebox.showerror("Error", "Mobile No. should be of ten digits")
        return
...
head=Label(frame2,text="Add Bus Operator Details",relief="ridge",fg="green",font=('Poppins',20,'bold'),padx=50)
...
opid=Label(frame3,text="Operator id :",font=('Poppins',12,'bold'))
...
name=Label(frame3,text="Name:",font=('Poppins',12,'bold'),padx=5)
...
address=Label(frame3,text="Address:",font=('Poppins',12,'bold'),padx=5)
...
phn=Label(frame3,text="Phone No. :",font=('Poppins',12,'bold'),padx=5)
...
email=Label(frame3,text="Email:",font=('Poppins',12,'bold'),padx=5)
email.grid(row=0,column=8,padx=5)

email_entry=Entry(frame3)
email_entry.grid(row=0,column=9)

add_button=Button(frame3,text="Add",command=add_op,bg="dark orchid",font=('Poppins',13,'bold'))
add_button.grid(row=0,column=10,padx=10)

edit_button=Button(frame3,text="Edit",command=edit_op,bg="gold2",font=('Poppins',13,'bold'))
